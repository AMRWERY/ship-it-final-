  ...
  <div>
    <div class="p-6">
      <div class="mb-12">
        ...
        <p class="text-gray-600 font-body">Manage your profile details</p>
      </div>
      ...
      <div class="flex">
        ...
        <ul :class="[
          ...
          <li role="presentation">
            <nuxt-link to=""
              class="flex items-center gap-2 border-l-4 border-transparent px-4 py-2 text-sm font-medium leading-tight text-neutral-500 hover:border-black hover:bg-neutral-100 focus:border-black data-[twe-nav-active]:border-black data-[twe-nav-active]:text-black cursor-pointer"
