      ...
      <nav class="flex" aria-label="Breadcrumb">
        <ol class="inline-flex items-center space-s-1 md:space-s-2 rtl:space-s-reverse">
          <li class="inline-flex items-center">
            <nuxt-link to="/" class="inline-flex items-center text-sm font-medium text-gray-700 hover:text-blue-600">
          ...
          <li v-if="breadcrumbLabel">
            <div class="flex items-center">
              ...
              <nuxt-link to="" class="text-sm font-medium text-gray-700 ms-1 hover:text-blue-600 md:ms-2">{{
